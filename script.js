...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      calc_label: "Request a Quote",
      calc_title: "Request a Quote",
      calc_desc: "Select your required services and provide your details to receive an accurate quote from our team.",
      ...
      result_heading: "Your Quote Summary",
      result_summary_desc: "Review your selected options below. We will provide a detailed quote once you submit your request.",
      result_disclaimer: "Please note: This is an estimated quote. The final price will be confirmed after an on-site assessment.",
      breakdown_base: "Service Type",
      breakdown_bedrooms: "Bedrooms",
      breakdown_bathrooms: "Bathrooms",
      breakdown_extras: "Add-ons",
      breakdown_freq: "Frequency",
      ...
      contact_payment: "Bank Transfer / Cash",
      form_name: "Full Name *",
      form_email: "Email *",
    ...
    ja: {
      ...
      calc_label: "お見積りのご依頼",
      calc_title: "お見積りのご依頼",
      calc_desc: "必要事項を入力いただくと、後ほど担当者より正確なお見積りをお送りします。",
      ...
      freq_monthly: "月一",
      result_heading: "選択内容の確認",
      result_disclaimer: "※担当者が内容を確認し、正確なお見積りをお送りします。",
